...
| 任务编号 | 任务标题 | 优先级 | 状态 | 备注 |
|---------|---------|--------|------|------|
| v1.6b-D1 | 审核外包飞机 P0（滚筒+倾斜） | P0 | 待开始 | J7W/J8M/A6M 共 12 张 |
| v1.6b-D2 | 审核外包飞机 P1（全 21 种） | P1 | 待开始 | 18 种敌机+2 Boss 共 45 张 |
...
| v1.6b-D8 | 审核外包玩家机精灵图 | P1 | 待开始 | 6 种 18 张（P-40~B-29） |
| v1.6b-D9 | 比例尺寸全局验证 | P1 | 待开始 | 75 张 9px/m 一致性 |
