...
| M3-A 基础修复 | **已通过** | A级 ✅ | A级 ✅ |
| M3-B 关卡扩展P1 | **已通过** | A级 ✅ | A级 ✅ |
| M3-C 关卡扩展P2+隐藏关 | **已通过** | A级 ✅ | A级 ✅ |
| M3-D 系统功能 | **已通过** | — | A-级 ✅ |
| M3-E 平台适配+性能 | **已通过** | — | A-级 ✅ |
| **M3 总体** | **已通过** | **A级平均** | **A-级平均** |
| M3-F 军衔+情报系统 | **已通过** | — | A级 ✅ |
| M3-G Phase 1 基础设施 | **已通过** | A级 ✅ | A-级 ✅ |
| M3-G Phase 2 场景+测试修复 | **已通过** | A级 ✅ | A级 ✅ |
| **M3-G 总体** | **已通过** | **A级** | **A级** |

> M3 任务分解详见 `docs/M3_task_breakdown.md`
> M3-G 补充设计详见 `docs/M3_G_map_design.md`
> M3-F 补充设计详见 `docs/M3_F_supplement_design.md`
