...
| BOSS ID | 名称 | 类型 | 描述 |
|---------|------|------|------|
| `tone` | 利根号 | 大型舰 | 重巡洋舰，航空甲板 |
| `shokaku` | 翔鹤号 | 航母 | 大型航母，飞行甲板，岛式舰桥 |
| `yamato` | 大和号 | 超大型舰 | 史上最大战列舰，3 联装主炮 |
| `yahata` | 八幡号 | 飞行要塞 | 虚构巨型飞行战舰，多层甲板 |
| `shinden_final` | 震电·改 | 隐藏 BOSS | 高速局地战斗机，黑色涂装，发光引擎 |
